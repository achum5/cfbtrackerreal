...
function ViewDynastyContent() {
  ...
  const phaseLong =
    currentDynasty.currentPhase === 'postseason'
      ...
      ? (currentDynasty.currentWeek === 1 ? 'Players Leaving' : (currentDynasty.currentWeek >= 2 && currentDynasty.currentWeek <= 4 ? `Recruiting Week ${currentDynasty.currentWeek - 1} of 3` : (currentDynasty.currentWeek === 5 ? 'National Signing Day' : (currentDynasty.currentWeek === 6 ? 'Signing Day Results' : (currentDynasty.currentWeek === 7 ? 'Training Camp' : 'Off-Season')))))
