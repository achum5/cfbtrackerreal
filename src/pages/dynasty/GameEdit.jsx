...
import { getWeek1BowlGamesList, getWeek2BowlGamesList } from '../../services/sheetsService'
  ...
  return (
    <div className="space-y-5">
      ...
      {(() => {
        ...
        return (
          <Card>
            {/* The settings gear lives joined to the Copy prompt button below
                (see copyLeading), matching the recap section — not floated in
                this header. */}
            <div className="mb-1">
