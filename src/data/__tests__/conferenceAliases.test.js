...
// Observed in EA's own ratings feed, which labels the conference
// { id: 'Big 10', label: 'Big Ten' } — the short form the game stores
// internally, and a real spelling this has to absorb.
describe('canonicalizeConferenceName — Big Ten short form', () => {
  it('maps the game\'s "Big 10" onto the canonical "Big Ten"', () => {
    expect(canonicalizeConferenceName('Big 10')).toBe('Big Ten')
  })
})
