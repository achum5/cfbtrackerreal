...
export default function ThresholdLookup({ players = [], teamColors, teamLogo, onGoToDatabase, onBack, dynastyId = null, recruitingDbIsolated = false, onToggleIsolated = null, jumpTarget = null, actionsRef = null, onReady = null }) {
