...
export default function Layout({ children }) {
  ...
  const { currentDynasty, advanceWeek, advanceToNewSeason, revertWeek, updateDynasty, phaseOverride, setPhaseOverride, advanceReadyInfo, toggleAdvanceReady, isViewOnly, migrateToSubcollections, isPcDynastyDataConfirmed } = useDynasty()
