...
// Paste self-heal for the grid lives in recruitDatabaseRealign.js
// (normalizeRecruitDatabaseRows) — a more robust deterministic realign than a
// simple trailing-cell keep: it also recovers a dropped State/Pos Rank
// (height-shift) and content-sorts the Gem/Bust · Dev · Attributes tail,
// while still handling the stray-blank-before-Attributes case.
