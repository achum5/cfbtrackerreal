            ...
            {isMobile || !useEmbedded ? (
              <div className="flex-1 flex flex-col items-center justify-center text-center p-4">
                ...
                <div className="text-left mb-4 max-w-xs">
                  ...
                  <ol className="text-sm space-y-1.5" style={{ color: teamColors.primary, opacity: 0.8 }}>
                    ...
                    <li className="flex gap-2"><span className="font-bold">2.</span><span>Enter Games Played, Games Started, Snaps Played</span></li>
              ...
              <>
                ...
                <div className="text-xs mt-2 space-y-1" style={{ color: teamColors.primary, opacity: 0.6 }}>
                  <p><strong>Columns:</strong> Player | Position | Class | Dev Trait | Overall | Games Played | Games Started | Snaps Played</p>
                  <p>Enter Games Played, Games Started, and Snaps Played for each player.</p>
                </div>
              </>
            )}
          </div>
