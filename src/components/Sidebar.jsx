...
export default function Sidebar({ isOpen, onClose, dynastyId, teamColors, currentYear }) {
  ...
  const navItems = [
    ...
    // Your Dynasty Journey
    {
      name: 'Coach Career',
      path: `/dynasty/${dynastyId}/coach-career`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      path: `/dynasty/${dynastyId}/team-achievements`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Dynasty Records',
      path: `/dynasty/${dynastyId}/dynasty-records`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
    ...
    {
      name: 'Players',
      path: `/dynasty/${dynastyId}/players`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Recruiting',
      path: `/dynasty/${dynastyId}/recruiting`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Leaders',
      path: `/dynasty/${dynastyId}/leaders`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'All-Time Lineup',
      path: `/dynasty/${dynastyId}/all-time-lineup`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'All-Americans',
      path: `/dynasty/${dynastyId}/all-americans`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
        </svg>
    ...
    {
      name: 'All-Conference',
      path: `/dynasty/${dynastyId}/all-conference`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'CFP Bracket',
      path: `/dynasty/${dynastyId}/cfp-bracket`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Bowl History',
      path: `/dynasty/${dynastyId}/bowl-history`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Rankings',
      path: `/dynasty/${dynastyId}/rankings`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
