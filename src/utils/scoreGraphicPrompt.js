...
export function buildScoreGraphicPrompt({
  ...
  if (featuredTeam === 0) {
    ...
    const lines = [
      ...
      homeTeam !== null ? `Score placement convention: AWAY team on the LEFT (or TOP), HOME team on the RIGHT (or BOTTOM). If you include a box score or quarter-by-quarter breakdown, list the AWAY team first and the HOME team second.` : null,
      ``,
